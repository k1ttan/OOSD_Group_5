	...
	import org.springframework.security.crypto.bcrypt.BCryptPasswordEncoder;
		...
		//	private CommonUtil commonUtil;
			...
			public String index(Model m) {
				List<Trip> startPoints = tripService.getAllTrips();
		        m.addAttribute("startPoints", startPoints);
				return "index";
			}
			@GetMapping("/search")
			public String showSearchForm(Model model) {
		        // Lấy danh sách các startPoint duy nhất từ cơ sở dữ liệu
		        List<String> startPoints = tripService.getAllStartPoint();
		        model.addAttribute("startPoints", startPoints); // Truyền danh sách startPoints sang view
		        List<String> endPoints = tripService.getAllEndPoint();
		        model.addAttribute("endPoints", endPoints);
		        return "index"; // Trả về tên của view hiển thị form tìm kiếm
		    }
